...
These samples are narrow (74×22) so they fit the page, and the [label
budget](#labels) scales with the canvas — a full terminal gets proportionally
more names than you see here.
...
budget — roughly one label per 100 character cells — and spends it on the most
