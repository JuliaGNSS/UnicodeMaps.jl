...
# original file: vector_tile.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Tile.Value"}, _endpos::Int=0, _group::Bool=false)
    string_value = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Tile.Feature"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Tile.Layer"}, _endpos::Int=0, _group::Bool=false)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"Tile.Layer")
    initpos = position(e.io)
    PB.encode(e, 15, x.version)
    PB.encode(e, 1, x.name)
...
function PB._encoded_size(x::var"Tile.Layer")
    encoded_size = 0
    encoded_size += PB._encoded_size(x.version, 15)
    encoded_size += PB._encoded_size(x.name, 1)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Tile}, _endpos::Int=0, _group::Bool=false)
